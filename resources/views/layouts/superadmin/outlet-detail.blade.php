        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
            <div class="row gx-4">
                <div class="col-lg-4 col-md-6">
                    <div class="fw-bold fs-4">Outlet 1</div>
                    <div class="fw-light fs-6">Jl. Pondok No. 123
                        RT 01 / RW 02
                        Kelurahan Pondok Indah
                        Kecamatan Tulungrejo Selatan
                        Kota Malang
                        12345
                        Indonesia</div>
                </div>
                ...
                <div class="col-12">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                            ...
                            <h6 class="text-uppercase text-body text-xs font-weight-bolder pt-3 pb-2">Keterangan</h6>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                                            <p class="text-s font-weight-light">Harga</p>
                                        </td>

                                        <td>
                                            <p class="text-s font-weight-light ml-3">: Rp. 800.000
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="text-s font-weight-light">Alamat</p>
                                        </td>

                                        <td>
                                            <p class="text-s font-weight-light ml-3">: Jane Doe
                                                Jl. Pondok No. 123
                                                RT 01 / RW 02
                                                Kelurahan Pondok Indah
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-s font-weight-light">Jumlah Kamar</p>
                                        </td>

                                        <td>
                                            <p class="text-s font-weight-light ml-3">: 8
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="text-s font-weight-light">Jumlah Kamar Terpakai</p>
                                        </td>

                                        <td>
                                            <p class="text-s font-weight-light ml-3">: 3
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="text-s font-weight-light">Jumlah Kamar Kosong</p>
                                        </td>

                                        <td>
                                            <p class="text-s font-weight-light ml-3">: 5
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="text-s font-weight-light">Kamar untuk</p>
                                        </td>

                                        <td>
                                            <p class="text-s font-weight-light ml-3">: Laki-Laki
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            <h6 class="text-uppercase text-body text-xs font-weight-bolder mt-4">Fitur</h6>
                            <ul>
                                <li>Kamar Mandi Dalam</li>
                                <li>Wifi</li>
                            </ul>
                            <h6 class="text-uppercase text-body text-xs font-weight-bolder mt-4">Tipe Kamar</h6>
                            <ul>
                                <li>Tipe 1</li>
                                <li>Tipe 2</li>
                            </ul>
