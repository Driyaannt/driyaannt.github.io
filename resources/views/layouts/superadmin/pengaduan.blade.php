                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="text-xs text-secondary mb-0">Paket Kamar 1</p>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">Kost Jl. Semarang</p>
                                            <p class="text-xs text-secondary mb-0">Paket Kamar 2</p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <p class="text-xs">Lorem ipsum dolor sit
                                                amet.</p>
